 ...
 *   npx jiti src/lib/ai/gaming-rerank/evaluator-cli.ts
 *   npx jiti src/lib/ai/gaming-rerank/evaluator-cli.ts --sweep
 *   npx jiti src/lib/ai/gaming-rerank/evaluator-cli.ts --pairs
 *   npx jiti src/lib/ai/gaming-rerank/evaluator-cli.ts --json --limit 500
 *   npx jiti src/lib/ai/gaming-rerank/evaluator-cli.ts --weight 0.5
 *
